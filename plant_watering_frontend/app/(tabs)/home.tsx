...
const HomeScreen = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('http://192.168.1.152:3000/SoilMoisture'); // Replace with your backend IP
...
const styles = StyleSheet.create({
  ...
  container: { flex: 1, justifyContent: 'space-between', alignItems: 'center', padding: 16 },
